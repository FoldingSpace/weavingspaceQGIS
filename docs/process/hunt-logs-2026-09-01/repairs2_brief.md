...
YOUR AREA: the repairs of 2026-09-01: the drag's units and span, the dual's lattice, the stale-table drop's candidate rule, the label-column reading and the per-door test teardown
