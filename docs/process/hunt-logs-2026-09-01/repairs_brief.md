...
YOUR AREA: the repairs of 2026-08-31 and 2026-09-01: the topology tab's pane floors and handle offsets, the two guards over the tab, and today's label-column retry and per-door test teardown
